...
var (
	...
	ec2Filters = map[string]string{
		...
		"/meta-data/operating-system/slug":    ".metadata.instance.operating_system_version.slug",
		"/meta-data/operating-system/distro":  ".metadata.instance.operating_system_version.distro",
		"/meta-data/operating-system/version": ".metadata.instance.operating_system_version.version",
		"/meta-data/operating-system/license_activation":       `"state"`,
		"/meta-data/operating-system/license_activation/state": ".metadata.instance.operating_system_version.license_activation.state",
		"/meta-data/operating-system/image_tag":                ".metadata.instance.operating_system_version.image_tag",
